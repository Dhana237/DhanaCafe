import React from 'react'
 import BannerImg from '../../assets/coffee08.png'
 import BgTexture from '../../assets/coffee12.jpg'
    ...
    <div data-aos='zoom-in'>
     ...
     gap-6 sm:pt-0'>
      ...
      tracking-wide leading-5'>
        ...
        reiciendis inventor iste ratione ex alias
        quis magni at optio
      </p>
      <div className='grid grid-cols-2 gap-6'>
        <div className='space-y-5'>
          ...
          <div 
           ...
           data-aos-offset='0'
           className='flex items-center gap-3'>
            <GiFoodTruck className='text-2xl h-12
            w-12 shadow-sm p-3 rounded-full
            bg-yellow-100'/>
        ...
        pl-6 space-y-3'>
          ...
          font-cursive'>Coffe Lover</h1>
          <p className='text-gray-500 text-sm'>
            {''}
            Much llike writing code,breming the
