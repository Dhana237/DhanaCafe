...
import HeroImg from '../../assets/coffee13.png';
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2'>
            ...
            <div className='order-2 sm:order-1'>
                ...
                lg:text-7xl font-bold'>
                    Sip, Smile, Repeat: the mantra of a 
                    <span
                    data-aos='zoom-out'
                    data-aos-delay='300' 
                    className='text-primary font-cursive'> Coffee</span> enthusiast.
                    </h1>
                    <div
                    data-aos='fade-up'
                    data-aos-delay='400'>
            ...
            relative'>
                ...
                <div data-aos='fade-left' className='bg-gradient-to-r from-primary
                to-secondary absolute top-10 left-10 p-3
                rounded-xl'>
                    <h1>Hey Coder</h1>
                    </div>
                    <div data-aos='fade-right'className='bg-gradient-to-r from-primary
